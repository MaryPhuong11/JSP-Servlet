...
<head>
    ...
    <title><fmt:message key="product.detail"/> - ${product.productName}</title>
...
<body class="bg-light">
    <div class="container py-4">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="products?lang=${currentLang}" class="text-decoration-none">
                        <i class="fas fa-home me-1"></i><fmt:message key="backToList"/>
                    </a>
                </li>
        ...
        <div class="language-tabs">
            <h5 class="mb-3">
                <i class="fas fa-language me-2"></i><fmt:message key="viewInOtherLanguage"/>
            </h5>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="price-display">
                    ...
                    <h3 class="fw-bold mb-2"><fmt:message key="price"/></h3>
                    <h2 class="fw-bold">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="category-info">
                    ...
                    <h3 class="fw-bold mb-2"><fmt:message key="category"/></h3>
            ...
            <div class="col-lg-4 col-md-12 mb-4">
                <div class="shipping-info ${product.productCategory.canBeShipped ? 'can-ship' : 'no-ship'}">
                    ...
                    <h3 class="fw-bold mb-2"><fmt:message key="shipping"/></h3>
                    <h4>
                        <c:choose>
                            <c:when test="${product.productCategory.canBeShipped}">
                                <i class="fas fa-check-circle me-2"></i><fmt:message key="shipping.can"/>
                            </c:when>
                            <c:otherwise>
                                <i class="fas fa-times-circle me-2"></i><fmt:message key="shipping.cannot"/>
                            </c:otherwise>
                        </c:choose>
                    </h4>
                </div>
            ...
            <div class="col-md-6">
                <div class="info-card">
                    <h5 class="fw-bold mb-3">
                        <i class="fas fa-weight-hanging me-2 text-primary"></i><fmt:message key="weight"/>
                    </h5>
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="text-muted"><fmt:message key="weight"/>:</span>
                        <span class="fw-bold fs-5">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <span class="text-muted"><fmt:message key="unknown"/></span>
                                </c:otherwise>
                            </c:choose>
                        </span>
                    </div>
            ...
            <div class="col-12 text-center">
                <div class="btn-group btn-group-lg" role="group">
                    <a href="products?lang=${currentLang}" class="btn btn-secondary">
                        <i class="fas fa-arrow-left me-2"></i><fmt:message key="backToList"/>
                    </a>
                    <a href="products?action=edit&id=${product.productId}" class="btn btn-warning">
                        <i class="fas fa-edit me-2"></i><fmt:message key="editProduct"/>
                    </a>
                    <button onclick="deleteProduct(${product.productId})" class="btn btn-danger">
                        <i class="fas fa-trash me-2"></i><fmt:message key="deleteProduct"/>
                    </button>
                </div>
            </div>
        </div>
