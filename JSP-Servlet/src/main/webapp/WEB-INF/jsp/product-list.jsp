            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
						...
						<a href="/JSP-Servlet" class="fas fa-boxes me-3"></a>
                            <i></i><fmt:message key="product.list.title"/>
                        </h1>
                        <p class="lead text-muted"><fmt:message key="product.list.subtitle"/></p>
                    </div>
                    <div>
                        <a href="products?action=add" class="btn btn-success btn-lg">
                            <i class="fas fa-plus me-2"></i><fmt:message key="product.add"/>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="language-selector">
                    <div class="d-flex align-items-center">
                        <h5 class="text-white mb-0 me-3">
                            <i class="fas fa-language me-2"></i><fmt:message key="language.select"/>
                        </h5>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0"><fmt:message key="stats.totalProducts"/></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0"><fmt:message key="stats.shippable"/></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0"><fmt:message key="stats.supportedLanguages"/></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row text-center mb-3">
                                <div class="col-6">
                                    <div class="border-end">
                                        <h6 class="text-muted mb-1"><fmt:message key="product.id"/></h6>
                                        <span class="fw-bold">#${product.productId}</span>
                                    </div>
                                </div>
                                <div class="col-6">
                                        <h6 class="text-muted mb-1"><fmt:message key="weight"/></h6>
                                    <span class="fw-bold">
                                        <c:choose>
                            ...
                            <div class="text-center mb-3">
                                <span class="price-tag">
                                    <i></i>
                                    <fmt:formatNumber value="${product.price}" pattern="#,##0.00"/> <fmt:message key="price.label"/>
                                </span>
                            </div>
                        </div>
                            ...
                            <div class="d-grid gap-2 d-md-block text-center">
                                <a href="products?action=detail&id=${product.productId}&lang=${currentLang}" 
                                   class="btn btn-primary btn-sm">
                                    <i class="fas fa-eye me-1"></i><fmt:message key="product.detail"/>
                                </a>
                                <a href="products?action=edit&id=${product.productId}" 
                                   class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit me-1"></i><fmt:message key="edit"/>
                                </a>
                                <button onclick="deleteProduct(${product.productId})" 
                                        class="btn btn-danger btn-sm">
                                    <i class="fas fa-trash me-1"></i><fmt:message key="delete"/>
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <c:if test="${empty products}">
            <div class="row">
                <div class="col-12 text-center py-5">
                    ...
                    <h3 class="text-muted"><fmt:message key="noProducts.title"/></h3>
                    <p class="text-muted"><fmt:message key="noProducts.subtitle"/></p>
                    <a href="products?action=add" class="btn btn-primary btn-lg">
                        <i class="fas fa-plus me-2"></i><fmt:message key="addFirstProduct"/>
                    </a>
                </div>
            </div>
        </c:if>
